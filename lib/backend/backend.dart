...
import 'schema/pre_buy_record.dart';
...
export 'schema/pre_buy_record.dart';
...
/// Functions to query PreBuyRecords (as a Stream and as a Future).
Future<int> queryPreBuyRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PreBuyRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PreBuyRecord>> queryPreBuyRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PreBuyRecord.collection,
      PreBuyRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PreBuyRecord>> queryPreBuyRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<PreBuyRecord>> queryPreBuyRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
