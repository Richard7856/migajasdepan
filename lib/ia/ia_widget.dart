...
export 'ia_model.dart';

class IaWidget extends StatefulWidget {
  const IaWidget({Key? key}) : super(key: key);

  @override
  _IaWidgetState createState() => _IaWidgetState();
}

class _IaWidgetState extends State<IaWidget> {
  late IaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IaModel());
